 ...
 * together. The guide's comment points back here. A verbatim-sync test in
 * tests/scaffold.test.ts pins the guide's quoted region to this constant
 * (hence the export).
 *
 * Keep it COMPACT — it is cached in every agent's prompt prefix.
 */
export const TELEGRAM_FORMATTING_FLOOR_CARD = `## Formatting for Telegram
