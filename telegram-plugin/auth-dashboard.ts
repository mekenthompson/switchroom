 ...
 * accepts email-shaped strings (`you@example.com`) and gmail-tag
...
export function buildDashboardText(state: DashboardState): string {
  ...
  // `● you@example.com (active) ✓ healthy` and the Pool line would
  // say `Pool: you@example.com is active` — both 1:1 duplicates of
